...
<html lang="en">
    <head>
        ...
        <title>Destination Confirm</title>
            ...
            <div class="container ">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 mb-5">
                        <div class="text-center">
                            <h1>CONFIRM <span class="font-weight-bold text-info"> DESTINATION</span></h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="form-control text-center confirm-info p-0">
                        <form method="post" action="CreateDestinationCompleteAction" >
                            <p>姓（全角）</p>
                            ...
                            <p>市町村</p>
                            <div class="confirm-user-info">
                            	<s:property  value="firstAddress" escape="false"/>
                            </div>
                            <p>丁・番地・マンション</p>
                            <div class="confirm-user-info">
                            	<s:property  value="secondAddress" escape="false"/>
                            </div>
                            <p>電話番号</p>
                            <div class="confirm-user-info">
