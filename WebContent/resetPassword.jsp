                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 mb-5">
                        <div class="text-center">
                            <h1>Change <span class="font-weight-bold text-info">Password</span></h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-control text-center p-0">
                        <form action="ResetPasswordConfirmAction" >
                            ...
                            <div class="form-group">
                                <s:textfield type="text" name="userId" class="form-control" />
                            </div>

                            <p>現在のパスワード</p>
                            <s:if test="currentPasswordErrorList!=null && currentPasswordErrorList.size()>0">
								<div class="error text-danger alert-danger font-weight-bold text-left">
									<s:property value="currentPasswordErrorList"/><br>
								</div>
							</s:if>
                            <div class="form-group">
                                <s:textfield type="password" name="currentPassword"  id="name"  class="form-control" />
                            </div>
                            <p>新しいパスワード</p>
                            ...
                            <s:if test="newPasswordErrorList!=null && newPasswordErrorList.size()>0">
								<div class="error text-danger alert-danger font-weight-bold">
									<s:property value="newPasswordErrorList"/><br>
								</div>
							</s:if>
                            <div class="form-group">
                                <s:textfield type="password" name="newPassword" class="form-control" />
                            </div>
                            <p>新しいパスワード（確認入力）</p>
                            <div class="form-group mt-2">
                                <input type="password" name="confirmNewPassword" class="form-control" required>
                            </div>
                            <button type="submit" class="login-submit btn btn-custom">CHANGE PASSWORD</button>
                        </form>
                    </div>
                </div>
