            ...
            <div class="container ">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 mb-5">
                        <div class="text-center">
                            <h1>MESSAGE <span class="font-weight-bold text-info">SENT</span></h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel order justify-content-center">
                    <div class="text-center p-0">
                        <p class="text-center">メッセージは送信されました。</p>
                        <p class="text-center mt-2">3~5営業日以内にお返事いたします。</p>

                        <a href='<s:url action="HomeAction"/>' class="btn btn-outline-dark btn-round btn1 mt-5">ホームへ戻る</a>
